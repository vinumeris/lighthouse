...
public class ClickableBitcoinAddress extends AnchorPane {
    ...
    public ClickableBitcoinAddress() {
        try {
            ...
            Tooltip.install(copyWidget, new Tooltip(tr("Copy address to clipboard")));

            qrCode.setCursor(Cursor.HAND);
            AwesomeDude.setIcon(qrCode, AwesomeIcon.QRCODE);
            Tooltip.install(qrCode, new Tooltip(tr("Show a barcode scannable with a mobile phone for this address")));
    ...
    protected void copyWidgetClicked(MouseEvent event) {
        copyAddress(null);
        GuiUtils.arrowBubbleToNode(copyWidget, tr("Address copied to clipboard"));
    }
    ...
    protected void showQRCode(MouseEvent event) {
        ...
        EmbeddedWindow window = new EmbeddedWindow(tr("QR code"), vbox);
